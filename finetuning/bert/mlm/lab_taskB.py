...
def main_train_val():
    ...
    wandb.init(project="bert-lab-mlm-taskB", entity="dcu-semval10", config=default_config)
    ...
    taskA['label'] = taskA['label_sexist'].apply(change_taskB_label)
...
if __name__ == '__main__':
    ...
    sweep_id = wandb.sweep(sweep = sweep_config, project='bert-lab-mlm-taskB')
